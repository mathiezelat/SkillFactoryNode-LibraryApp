...
import { Input, Label, GroupInput, LegendError, IconValidation } from '../elements/Forms';
import { faCircleCheck, faTimesCircle } from '@fortawesome/free-solid-svg-icons';


const ComponentInput = ({ estado, cambiarEstado, label, placeholder, type, name, legendError, regularPhrase, funcion }) => {
